...
export const fetchHypercertIDs = async () => {
  const [response, error] = await tryCatch(
    async () =>
      await fetchGraphQL(hypercertIdsByHyperboardIdQuery, {
...
export const fetchHypercertById = async (
  ...
  const [response, error] = await tryCatch(
    async () =>
      await fetchGraphQL(hypercertByHypercertIdQuery, {
...
export const fetchHypercerts = async () => {
  ...
  const [hypercerts, error] = await tryCatch(
    async () => await Promise.all(hypercertPromises)
  );
  console.log(error);
